...
export async function fileFromPath() {
  throw new Error(
    'The `fileFromPath` function is only supported in Node. See the README for more details: https://www.github.com/Modern-Treasury/modern-treasury-node#file-uploads',
  );
}
