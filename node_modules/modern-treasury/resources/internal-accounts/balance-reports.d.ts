...
export declare class BalanceReports extends APIResource {
  /**
...
export declare class BalanceReportsPage extends Page<BalanceReport> {}
...
export declare namespace BalanceReport {
  interface Balance {
    id: string;
    /**
     * The balance amount.
...
export declare namespace BalanceReports {
  ...
  type BalanceReportsPage = _BalanceReportsPage;
  export import BalanceReportListParams = API.BalanceReportListParams;
}
export {};
//# sourceMappingURL=balance-reports.d.ts.map
