...
export declare class LedgerAccountStatements extends APIResource {
  /**
...
export declare namespace LedgerAccountStatementCreateResponse {
  /**
   * The pending, posted, and available balances for this ledger account at the
   * `effective_at_upper_bound`. The posted balance is the sum of all posted entries
   * on the account. The pending balance is the sum of all pending and posted entries
...
export declare namespace LedgerAccountStatementRetrieveResponse {
  /**
   * The pending, posted, and available balances for this ledger account at the
   * `effective_at_upper_bound`. The posted balance is the sum of all posted entries
   * on the account. The pending balance is the sum of all pending and posted entries
...
//# sourceMappingURL=ledger-account-statements.d.ts.map
