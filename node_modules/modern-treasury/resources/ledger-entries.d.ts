...
export declare class LedgerEntriesPage extends Page<LedgerEntry> {}
...
export declare namespace LedgerEntry {
  /**
   * The pending, posted, and available balances for this ledger entry's ledger
   * account. The posted balance is the sum of all posted entries on the account. The
   * pending balance is the sum of all pending and posted entries on the account. The
...
export declare namespace LedgerEntryListParams {
  /**
   * Order by `created_at` or `effective_at` in `asc` or `desc` order. For example,
   * to order by `effective_at asc`, use `order_by%5Beffective_at%5D=asc`. Ordering
   * by only one field at a time is supported.
...
export declare namespace LedgerEntries {
  ...
  type LedgerEntriesPage = _LedgerEntriesPage;
