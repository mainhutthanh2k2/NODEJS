...
export declare class PaymentReferences extends APIResource {
  /**
...
export declare class PaymentReferencesPage extends Page<PaymentReference> {}
...
export declare namespace PaymentReferences {
  ...
  type PaymentReferencesPage = _PaymentReferencesPage;
  export import PaymentReferenceListParams = API.PaymentReferenceListParams;
}
export {};
//# sourceMappingURL=payment-references.d.ts.map
